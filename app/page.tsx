  ...
  return (
    <main className="relative">
      ...
      <div data-nav-theme="dark">
        <ImageBand src="/images/outreach-blue.jpg" alt="Students at an ACHII climate-health school outreach assembly" />
      </div>
      <div data-nav-theme="dark"><ResearchStudy /></div>
      <div data-nav-theme="light"><HomeInsights /></div>
      <div data-nav-theme="dark">
        <ImageBand src="/images/outreach-crowd.jpg" alt="Students gathered at an ACHII school outreach event" height="h-[552px] md:h-[929px]" />
      </div>
